 ...
 *
 * A animação do logo dura 3s por loop; a tela deve durar pelo menos
 * 1 execução (3s), mesmo que os dados já estejam prontos.
 *
 * O timer começa na montagem do componente que usa o hook e não reinicia.
 */
export function useSplashGate(isLoading: boolean, minMs = 3000): boolean {
